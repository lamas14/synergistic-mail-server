...
<body>
	<div id="main_container">
		<div id="header">
			<div id="logo">
				<a href="home.html"><img src="images/logo.gif" alt="" title=""
					border="0" /></a>
			</div>
			...
			<div id="menu">
				<ul>
					...
					<li><a href="services.html" title="">Leave</a></li>
		...
		<div class="green_box">
			<div class="clock">
				<img src="images/emaillogo.jpg" alt="" title="" />
			</div>
		...
		<div id="main_content">
			<div id="left_content">
				<img src="images/loginpage.png" alt="" title=""
					border="0" />
		...
		<div id="footer">
			<div class="copyright">
				<a href="home.html"><img src="images/footer_logo.gif" border="0"
					alt="" title="" /></a>
			</div>
